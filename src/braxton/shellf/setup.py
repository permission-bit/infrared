...
def setup_shell_functions():
    if platform.system() != "Darwin":
        print("You have to use MacOS to execute this function!")
        return

    print("=" * 50)

    function_path = Path.home() / ".zsh" / "functions" / "dev.zsh"
    function_path.parent.mkdir(parents=True, exist_ok=True)
    function_path.write_text(CONTENT, encoding="utf-8")

    zshrc = Path.home() / ".zshrc"

    source_line = "source ~/.zsh/functions/dev.zsh"
    ...
    print("=" * 50)
    print("run source ~/.zshrc in your terminal to reload and its done!")
    print("type dev in a new terminal to see functions you can use.")
